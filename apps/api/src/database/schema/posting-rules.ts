...
export const postingRules = pgTable('posting_rules', {
  ...
  // GL-24 (0330): rule changes are governed config — API writes land PendingApproval and only a
...
// GL-24 append-only audit trail: every CREATE/APPROVE/REJECT/DEACTIVATE on a posting rule (0330).
