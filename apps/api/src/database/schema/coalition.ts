...
import { pgTable, bigserial, bigint, text, timestamp, boolean, uniqueIndex } from 'drizzle-orm/pg-core';
...
export const coalitionMembers = pgTable('coalition_members', {
  ...
  createdBy: text('created_by'),
}, (t) => ({ uqShop: uniqueIndex('coalition_members_coalition_tenant').on(t.coalitionId, t.tenantId) }));
