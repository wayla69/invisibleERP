...
@Module({ imports: [MessagingModule, FinanceModule, EamModule, LedgerModule, LeasesModule, RevenueModule, ProjectsModule, CrmPipelineModule, BudgetModule, ProcurementModule, MatchModule], providers: [BiService, BiLiveService], controllers: [BiController], exports: [BiService] })
