...
export class HcmController {
  ...
  approveLeave(@Param('id') id: string, @CurrentUser() u: JwtUser, @Body(new ZodValidationPipe(SelfApprovalBody)) b?: SelfApprovalDto) { return this.svc.approveLeave(Number(id), u, b?.self_approval_reason); }
}
