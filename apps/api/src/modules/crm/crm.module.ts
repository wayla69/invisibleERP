...
// can keep resolving.
@Module({
  imports: [CrmPipelineModule, PipelineModule, CrmAccountsModule, CrmAccountDepthModule, CrmInboundModule, FinanceModule],
  controllers: [CrmController],
  providers: [CrmService],
  exports: [CrmService, CrmPipelineModule, PipelineModule, CrmAccountsModule, CrmAccountDepthModule, CrmInboundModule],
})
