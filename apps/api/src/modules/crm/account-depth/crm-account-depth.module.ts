import { Inject, Injectable, Module, Controller, Get, Post, Patch, Delete, Param, Query, Body, NotFoundException, BadRequestException, ConflictException, HttpCode } from '@nestjs/common';
import { z } from 'zod';
...
// ── CRM-7 — B2B Account/Contact 360 DEPTH (REV-24, migration 0356) ──────────────────────────────────
...
const ParentBody = z.object({ parent_account_no: z.string().min(1).nullish() });
