import { Inject, Injectable, Module, Controller, Get, Post, Patch, Param, Query, Body, Optional, NotFoundException, BadRequestException, HttpCode } from '@nestjs/common';
import { z } from 'zod';
...
const DealTypeBody = z.object({ deal_type: z.enum(['new', 'renewal', 'expansion']) });
