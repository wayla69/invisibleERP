...
@Module({ imports: [WorkflowModule, CostingModule, PlatformModule, MessagingModule, CommitmentsModule], controllers: [ProcurementController], providers: [ProcurementService, AttachmentsService], exports: [ProcurementService, AttachmentsService] })
