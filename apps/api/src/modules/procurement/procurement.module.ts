...
import { ProcurementBiReports } from './procurement-bi-reports';
...
@Module({ imports: [WorkflowModule, CostingModule, PlatformModule, MessagingModule, CommitmentsModule, DocumentTemplatesModule], controllers: [ProcurementController], providers: [ProcurementBiReports, ProcurementService, AttachmentsService, PoPdfService, GrPdfService, ImageFetchService], exports: [ProcurementService, AttachmentsService] })
