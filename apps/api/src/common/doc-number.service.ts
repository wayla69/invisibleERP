...
type DailyType = 'PO' | 'GR' | 'ST' | 'PR' | 'DO' | 'RCP' | 'GRC' | 'AP' | 'RTN' | 'JE' | 'PAY' | 'REF' | 'TILL' | 'DIN' | 'TS' | 'FA' | 'DEP' | 'SPLIT' | 'CASHMOV' | 'BANKSTMT' | 'BANKADJ' | 'DEFREV' | 'REVREC' | 'IC' | 'GC' | 'GCT' | 'RFQ' | 'QTE' | 'MAT' | 'WAVE' | 'PICK' | 'SHP' | 'RPL' | 'RMA' | 'MI' | 'WO';
