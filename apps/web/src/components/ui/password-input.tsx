...
function PasswordInput({ className, ...props }: Omit<React.ComponentProps<'input'>, 'type'>) {
  // useLang is provider-safe: outside a LanguageProvider (login/signup) it falls back to Thai.
  const { t } = useLang();
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        tabIndex={-1}
        aria-pressed={show}
        aria-label={t(show ? 'common.hide_password' : 'common.show_password')}
        title={t(show ? 'common.hide_password' : 'common.show_password')}
