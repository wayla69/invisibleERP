...
export default function OpsPage() {
  ...
  return (
    <div>
      <PageHeader title="ระบบ & การขยายขนาด (Ops)" description="สถานะกระบวนการ + posture การขยายขนาด (cache / queue) — health probes: /healthz /readyz" />
      <StateView q={q}>
        {q.data && (
          <div className="grid gap-4 md:grid-cols-3">
            <Card><CardHeader><CardTitle className="flex items-center gap-2 text-base"><Activity className="size-4 text-primary" /> กระบวนการ</CardTitle></CardHeader><CardContent className="text-sm"><p>Uptime: {q.data.uptime_s}s</p><p>Node: {q.data.node}</p></CardContent></Card>
