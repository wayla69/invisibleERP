...
- **Honest current baseline + ID crosswalk:** see [`CONTROL_STATUS_HONEST.md`](CONTROL_STATUS_HONEST.md) — current status is **<!-- rcm-implemented -->252<!-- /rcm-implemented --> Implemented / <!-- rcm-partial -->3<!-- /rcm-partial --> Partial / <!-- rcm-gap -->0<!-- /rcm-gap --> Gap of <!-- rcm-total -->255<!-- /rcm-total -->** (the 3 Partials are entity-level governance operation, not software), and the realistic management-ICFR-assertion (404(a)) target is **Q1 2027 at the earliest**. Until then we say "control environment built and ToE-tested", **not** "audit-ready".
- **Honest current baseline + ID crosswalk:** see [`CONTROL_STATUS_HONEST.md`](CONTROL_STATUS_HONEST.md) — current status is **<!-- rcm-implemented -->252<!-- /rcm-implemented --> Implemented / <!-- rcm-partial -->3<!-- /rcm-partial --> Partial / <!-- rcm-gap -->0<!-- /rcm-gap --> Gap of <!-- rcm-total -->255<!-- /rcm-total -->** (the 3 Partials are entity-level governance operation, not software), and the realistic management-ICFR-assertion (404(a)) target is **Q1 2027 at the earliest**. Until then we say "control environment built and ToE-tested", **not** "audit-ready".
- **Honest current baseline + ID crosswalk:** see [`CONTROL_STATUS_HONEST.md`](CONTROL_STATUS_HONEST.md) — current status is **<!-- rcm-implemented -->252<!-- /rcm-implemented --> Implemented / <!-- rcm-partial -->3<!-- /rcm-partial --> Partial / <!-- rcm-gap -->0<!-- /rcm-gap --> Gap of <!-- rcm-total -->255<!-- /rcm-total -->** (the 3 Partials are entity-level governance operation, not software), and the realistic management-ICFR-assertion (404(a)) target is **Q1 2027 at the earliest**. Until then we say "control environment built and ToE-tested", **not** "audit-ready".
- **Honest current baseline + ID crosswalk:** see [`CONTROL_STATUS_HONEST.md`](CONTROL_STATUS_HONEST.md) — current status is **<!-- rcm-implemented -->252<!-- /rcm-implemented --> Implemented / <!-- rcm-partial -->3<!-- /rcm-partial --> Partial / <!-- rcm-gap -->0<!-- /rcm-gap --> Gap of <!-- rcm-total -->255<!-- /rcm-total -->** (the 3 Partials are entity-level governance operation, not software), and the realistic management-ICFR-assertion (404(a)) target is **Q1 2027 at the earliest**. Until then we say "control environment built and ToE-tested", **not** "audit-ready".
