...
> **Relationship to SOX work:** SOC 2 and SOX share most of their ITGC DNA. The <!-- rcm-total -->305<!-- /rcm-total -->-control RCM
> (<!-- rcm-implemented -->302<!-- /rcm-implemented --> Implemented; census: `build_rcm.py --counts`) built for SOX 404(a) is the primary evidence base for SOC 2. The gap between
> **Relationship to SOX work:** SOC 2 and SOX share most of their ITGC DNA. The <!-- rcm-total -->305<!-- /rcm-total -->-control RCM
> (<!-- rcm-implemented -->302<!-- /rcm-implemented --> Implemented; census: `build_rcm.py --counts`) built for SOX 404(a) is the primary evidence base for SOC 2. The gap between
> **Relationship to SOX work:** SOC 2 and SOX share most of their ITGC DNA. The <!-- rcm-total -->305<!-- /rcm-total -->-control RCM
> (<!-- rcm-implemented -->302<!-- /rcm-implemented --> Implemented; census: `build_rcm.py --counts`) built for SOX 404(a) is the primary evidence base for SOC 2. The gap between
...
| TSC point | Existing evidence | Evidence status |
|---|---|---|
| CC5.1 Selects and develops control activities | <!-- rcm-total -->305<!-- /rcm-total -->-control RCM with preventive + detective + automated split; per-cycle control matrices in narratives | ✅ Designed |
| CC5.1 Selects and develops control activities | <!-- rcm-total -->305<!-- /rcm-total -->-control RCM with preventive + detective + automated split; per-cycle control matrices in narratives | ✅ Designed |
| CC5.1 Selects and develops control activities | <!-- rcm-total -->305<!-- /rcm-total -->-control RCM with preventive + detective + automated split; per-cycle control matrices in narratives | ✅ Designed |
| CC5.1 Selects and develops control activities | <!-- rcm-total -->305<!-- /rcm-total -->-control RCM with preventive + detective + automated split; per-cycle control matrices in narratives | ✅ Designed |
