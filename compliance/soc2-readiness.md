...
> **Relationship to SOX work:** SOC 2 and SOX share most of their ITGC DNA. The <!-- rcm-total -->200<!-- /rcm-total -->-control RCM
> (<!-- rcm-implemented -->197<!-- /rcm-implemented --> Implemented; census: `build_rcm.py --counts`) built for SOX 404(a) is the primary evidence base for SOC 2. The gap between
...
| TSC point | Existing evidence | Evidence status |
|---|---|---|
| CC5.1 Selects and develops control activities | <!-- rcm-total -->200<!-- /rcm-total -->-control RCM with preventive + detective + automated split; per-cycle control matrices in narratives | ✅ Designed |
...
| 11 | Third-party penetration test (CC7.4 / CC6.8 complement) — RFP scope drafted, `compliance/pentest-rfp.md`; vendor not yet selected | External firm | M |
...
| 0.4 DRAFT | 2026-07-08 | Platform | Priority-2 item 11 note: penetration-test RFP scope drafted (`compliance/pentest-rfp.md`) — vendor sourcing in progress; still outstanding until an engagement is actually run. |
