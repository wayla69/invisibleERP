...
> (Logical Access, System Operations, Change Management, Risk Mitigation). The <!-- rcm-total -->169<!-- /rcm-total -->-control RCM built for SOX
...
| 0.2 DRAFT | 2026-07-02 | Platform | Census reconciliation (docs/24 R3-1): SOX-RCM population reference corrected to the generated census (169) with a machine-readable tag. |
