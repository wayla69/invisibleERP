...
add("INV-05","Inventory & COGS","Application","Inventory; COGS","Perpetual stock VALUE drifts from the GL inventory control account; receipts/issues/adjustments uncosted or not posted to GL → inventory & COGS misstated.","Existence/Valuation/Completeness",
