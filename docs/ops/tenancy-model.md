...
> - **Company soft-delete (suspended companies only, migration 0393).** Lighter than factory-reset above —
...
> - **Company purge (already-soft-deleted companies only, migration 0393, IRREVERSIBLE).** The follow-up to
