...
| 4 (rest) | Remaining ~11 raw-table pages, per area (finance analytics clients — close-cockpit/treasury/profitability/financial-statements/gl-schedules — last; plus loyalty ladder editor, display terminal) | planned |
