...
- Code:
  ...
  - `apps/api/src/modules/crm/pipeline/crm-pipeline.service.ts` — the UNIFIED opportunity spine (CRM-1, migration 0294); `pipeline.controller.ts`/`pipeline.service.ts` — the legacy `/api/pipeline` routes as thin adapters over it
