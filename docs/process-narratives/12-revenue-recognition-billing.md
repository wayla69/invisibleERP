...
- **`advance` (customer prepays)** — the entity holds the customer's cash, so the financing benefit unwinds as **financing interest income (4650)**, releasing a slice of the contract liability: **Dr 2410 / Cr 4650**.
- **`arrears` (deferred payment)** — the entity finances the customer, so the financing charge accretes the contract asset / receivable against the **net interest line (5900)**: **Dr 1265 / Cr 5900**.
...
| Event | Source | Debit | Credit |
| --- | --- | --- | --- |
| `advance` interest unwind (customer prepays) | `REVFIN` | 2410 Contract Liability (release financing benefit) | **4650 Significant Financing Component Interest Income** |
| `arrears` interest unwind (deferred payment) | `REVFIN` | 1265 Contract Asset (accrete receivable) | 5900 Interest (net interest line) |

**New COA 4650** (Significant Financing Component Interest Income) is added to the canonical COA + `CF_CLASSIFY` (operating); the arrears case reuses **5900**.
...
flowchart TD
    ...
    G --> H[advance Dr 2410 Cr 4650 interest income]
    G --> I[arrears Dr 1265 Cr 5900 interest]
