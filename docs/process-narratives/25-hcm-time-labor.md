...
| 1.2 | 2026-07-15 | Platform / Compliance | SME edition exception note added to the control matrix (docs/49 v1.2, control SME-01) — maker-checker self-approval blocks are conditionally relaxed for `control_profile='sme'` tenants via the central seam; no control logic changed in this cycle. |
