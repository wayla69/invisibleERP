...
| Related RCM controls | MFG-01, MFG-02, MFG-03, QC-01, GL-01, INV-01; SoD R04, R13, R21 |
...
- Code (QC-01): `apps/api/src/modules/mfg-depth/ncr.service.ts` + `mfg-depth.controller.ts` (`NcrController`), `apps/api/src/database/schema/quality-ncr.ts`, migration `apps/api/drizzle/0331_quality_ncr.sql`; ToE `tools/cutover/src/quality-ncr.ts`.
