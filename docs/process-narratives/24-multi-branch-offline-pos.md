...
6c. **Hub → cloud sales replay (machine-to-machine; docs/41 Phase 2a).** Sales rung ON a store hub post
   ...
   hub-side `hub_push_log` (migration `0292`); a sale the pusher cannot faithfully replay (buffet tier,
