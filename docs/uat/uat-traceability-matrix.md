...
| UAT-INV-106 | Backward trace — lot → goods receipt → supplier | INV-18 | 03 §7 (15), rev 1.4 (`lot-trace.ts`) |
| UAT-INV-107 | Forward trace — lot → issue/pick → sale/customer | INV-18 | 03 §7 (15), rev 1.4 (`lot-trace.ts`) |
| UAT-INV-108 | Lot hold quarantines — excluded from FEFO + WMS wave allocation | INV-18 | 03 §7 (15), §9 (15) (`lot-trace.ts`) |
| UAT-INV-109 | Release re-enables the lot; non-held release rejected (`LOT_NOT_HELD`) | INV-18 | 03 §7 (15) (`lot-trace.ts`) |
| UAT-INV-110 | Trace an unknown lot rejected (`LOT_NOT_FOUND`) | INV-18 | 03 §7 (15) (`lot-trace.ts`) |
