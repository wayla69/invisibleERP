...
| UAT-P2P-093 | Convert approved PR → PO (item reconcile against master + open new code) | EXP (PR→PO link) | 02 rev 2.3 |
| UAT-P2P-094 | One-tap รับครบ (receive-all) — web button + LINE `receive <PO no>`; EXP-03 approval gate + R04 hold | EXP-02, EXP-03, R04 | 02 rev 2.4 |
