...
| UAT-P2P-081 | AP intake: scan with PO no. → auto-map + book + match in one flow | EXP-10, EXP-01 | 02 §3, §7, §9 |
| UAT-P2P-082 | AP intake: vendor+amount auto-map only when unambiguous; ties → NeedsReview | EXP-10 | 02 §7, §9 |
