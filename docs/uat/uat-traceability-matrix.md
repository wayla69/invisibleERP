...
| UAT-O2C-183 | Lead → convert → customer-of-record + opportunity | REV-16 | 01 §7, §9 |
| UAT-O2C-184 | Opportunity stage machine (won terminal) | REV-16 | 01 §7, §9 |
| UAT-O2C-185 | Marking lost requires a reason | REV-16 | 01 §7, §9 |
| UAT-O2C-186 | Weighted pipeline forecast + win-rate | REV-16 | 01 §7 |
| UAT-O2C-187 | Log + list a CRM activity | REV-16 | 01 §7 |
