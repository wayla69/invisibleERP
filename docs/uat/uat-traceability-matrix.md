...
| UAT-P2P-110 | PR→PO auto-group by supplier (1 PR → many POs) + item ผู้ขายประจำ (preferred supplier) + item names | EXP-02, EXP-03, R02/R07 (unchanged); PR→PO link | 02 rev 3.19 |
