...
| UAT-INV-106 | ABC recompute tiers items by consumption value (A/B/C) + seeds per-class cadence | INV-17 | 03 §7 (13b), §9, rev 1.4 (`cycle-counts.ts`) |
| UAT-INV-107 | Cadence-driven cycle-count due worklist (never-counted first) | INV-17 | 03 §7 (13b), rev 1.4 (`cycle-counts.ts`) |
| UAT-INV-108 | Blind count — book qty never returned to the counter | INV-17 | 03 §7 (13b), §8, rev 1.4 (`cycle-counts.ts`) |
| UAT-INV-109 | Count entry → post via the existing INV-04 counter≠poster path + valued GL adjustment | INV-17 · INV-04 · INV-06 | 03 §7 (13b), rev 1.4 (`cycle-counts.ts`) |
| UAT-INV-110 | INV-04 self-post blocked on a cycle count (`SOD_SELF_APPROVAL`) | INV-17 · INV-04 · R11 | 03 §7 (13b), §8, rev 1.4 (`cycle-counts.ts`) |
