...
| UAT-GL-159 | Account-universe guard: posting to a non-existent / non-postable account fails INVALID_POSTING_ACCOUNT (docs/42) | GL-21 | 05 rev 0.36 (`compliance.ts`) |
| UAT-GL-160 | /chart-of-accounts manage surface: canonical create/edit/deactivate + per-tenant overlay (docs/42) | GL-11 | 05 rev 0.36 (`basics.ts`) |
| UAT-GL-161 | posting_determination master switch on /setup/item-categories (docs/42) | GL-12 | 05 rev 0.36 (`basics.ts`) |
| UAT-GL-162 | GL-24 posting-rule validation fail-closed at save (pinned/unknown-role/side/account) | GL-24 | 05 rev 0.36 (`compliance.ts`) |
| UAT-GL-163 | GL-24 maker-checker: pending rule never posts; distinct approver activates (SOD_VIOLATION) | GL-24 | 05 rev 0.36 (`compliance.ts`, `payroll.ts`) |
| UAT-GL-164 | GL-24 audit trail (CREATE/APPROVE append-only) + deactivate falls back to the registry default | GL-24 | 05 rev 0.36 (`compliance.ts`) |
| UAT-GL-166 | docs/43 PR-2: approved override re-routes a wired finance posting; unapproved never applies; register keys on the debit leg | GL-24, REV-14 | 05 rev 0.36 (`basics.ts`) |
