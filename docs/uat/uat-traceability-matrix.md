...
| UAT-O2C-279 | Delivery open-orders pending list → `/delivery` SO dropdown (`GET /api/delivery/open-orders`) | Read-only feed (no new control) | 01 §7, rev 0.28 (`gaps.ts`) |
