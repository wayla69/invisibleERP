...
| UAT-P2P-005 | Matched pay (request+approve) + GL | EXP-05, GL-01 | 02 §7 |
...
| UAT-P2P-009 | Override-with-reason (request+approve) | EXP-05, R04 | 02 §9 |
| UAT-P2P-010 | Override reset on re-match | EXP-03 | 02 §9, §13 |
| UAT-P2P-011 | Non-PO bill (gate fails open, request+approve) | EXP-05 | 02 §7 |
...
| UAT-P2P-023 | AP payment-request idempotency | EXP-05 / GL-01 | 02 §7 |
...
| UAT-P2P-029 | Pre-paid bill creation blocked | EXP-05 | 02 §7, §9 |
| UAT-P2P-030 | Payment request creates no GL/paid effect | EXP-05 | 02 §7, §9 |
| UAT-P2P-031 | Requester self-approval blocked (SoD, incl. Admin) | EXP-05, R03/R07 | 02 §7, §9 |
| UAT-P2P-032 | Maker without approval authority blocked | EXP-05 | 02 §7, §9 |
| UAT-P2P-033 | Reject leaves bill unpaid | EXP-05 | 02 §7, §9 |
