...
| UAT-O2C-286 | CRM-1 unified pipeline: one deal list through both route families | REV-17 | 18 §7 (2), rev 0.5 (pipeline.ts) |
| UAT-O2C-287 | Stage-transition audit trail (crm_stage_history) | REV-17 | 18 §7 (2), rev 0.5 (pipeline.ts) |
| UAT-O2C-288 | Won/lost terminal on the legacy /api/pipeline route | REV-17 | 18 §7 (2), rev 0.5 (pipeline.ts) |
| UAT-O2C-289 | CRM account/contact duplicate detection + steward force | REV-17 (ext.) | 18 §7 (1b), rev 0.5 (pipeline.ts) |
| UAT-O2C-290 | Account merge: maker-checker + survivor repoint | REV-17 (ext.) | 18 §7 (1b), rev 0.5 (pipeline.ts) |
| UAT-O2C-291 | CPQ quote ↔ unified opportunity link (incl. 0293 data-migration) | REV-17, CPQ-01 | 18 §7 (2)/(5), rev 0.5 (pipeline.ts) |
