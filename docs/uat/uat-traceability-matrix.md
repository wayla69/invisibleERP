...
| UAT-O2C-279 | Delivery open-orders pending list → `/delivery` SO dropdown (`GET /api/delivery/open-orders`) | Read-only feed (no new control) | 01 §7, rev 0.3 (`gaps.ts`) |
...
| UAT-P2P-120 | Doc-reference dropdowns on the P2P screens (pending lists; manual escape) | Usability over EXP-01..03 (no new control) | 02 §7, rev 0.9 (manual/UI) |
