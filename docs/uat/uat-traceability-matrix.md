...
| UAT-ADM-142 | SoD-conflict register — standing dashboard, conflicts by rule | ITGC-AC-22, R07 | 08 §9 (`sod-register.ts`) |
| UAT-ADM-143 | Accept requires compensating control/owner/expiry; NO_SUCH_CONFLICT | ITGC-AC-22 | 08 §9 (`sod-register.ts`) |
| UAT-ADM-144 | Accept conflict → acceptor recorded; dashboard reflects | ITGC-AC-22, R07 | 08 §9 (`sod-register.ts`) |
| UAT-ADM-145 | Expired/overdue worklist + periodic re-review clears | ITGC-AC-22 | 08 §9 (`sod-register.ts`) |
| UAT-ADM-146 | Register permission-gated + RLS isolated | ITGC-AC-22 | 08 §9 (`sod-register.ts`) |
