...
> **Date:** 2026-07-05 · **Status:** v0.5 — **P0–P3 DELIVERED** (retention sub-ledger; progress billing PROJ-15; subcontractor management PROJ-16; tender→award PROJ-17) — **contractor track complete**; Track D (real-estate) **PLANNED** · **Owner:** ERP / Product
...
| **P4** | **Track D1–D2** RE units + booking/contract/installments | 0253+ | **RE-01/02/03** | new `realestate` harness — unit lifecycle, contract SoD, installment receipts/dunning |
