...
> **Date:** 2026-07-05 · **Status:** v0.4 — **P0 + P1 + P2 DELIVERED** (retention sub-ledger; progress billing PROJ-15; subcontractor management + retention payable PROJ-16); Track C (tender) + Track D (real-estate) **PLANNED** · **Owner:** ERP / Product
