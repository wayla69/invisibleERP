...
enabling schema is **migration `0476`** — additive `scm_demand_forecasts.sample_paths jsonb` (the reconciled
...
**D1 shipped** (batch retrain + forecast-source seam, migration 0476, contract unchanged); **D4** lands
