...
| v0.8 | 2026-07-13 | G3 weather-overlay residual DELIVERED — opt-in `weather` demand-ml candidate (Open-Meteo, `DEMAND_WEATHER_ENABLED`), PN-26 rev 2.4. All docs/45 roadmap items are now fully delivered; no stated residuals remain. |
