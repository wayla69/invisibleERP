...
> **Date:** 2026-07-02 · **Status:** v1.3 — **IN EXECUTION (PRs 1–3 shipped: payments ✅, tax ✅, crm/pipeline ✅)** · **Owner:** ERP / Platform
...
rejected as non-mechanical) → 4. **loyalty** → 5. **pos** (largest; last, after the recipe is boring).
