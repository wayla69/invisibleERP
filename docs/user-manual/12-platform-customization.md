...
| Customize how documents look (receipt · **quotation · purchase order · payslip · full tax invoice (ใบกำกับภาษีเต็มรูป)**; the abbreviated 80mm tax invoice is previewable) — accent colour, logo, header note, show/hide seller address·tax-id, amount-in-words, signature captions, footer terms. Tax-document mandatory fields always print (§86/4). | **Document templates** | `/document-templates` | users / exec | [Administration §14](./11-administration.md) |
