...
> **Print / email the receipt voucher (ใบสำคัญรับเงิน):** open
> `GET /api/finance/ar/receipts/{RCP-…}/pdf` for a printable receipt voucher, or
> `POST …/send-email {to_email}` to email it to the customer as a PDF. (This is the AR
