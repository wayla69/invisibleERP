...
- Row **เพิ่มบัญชีย่อย** (layers icon, Admin/HQ) opens the same dialog **pre-set as a sub-account** of
  ...
  such as *5150 ค่าเดินทาง* is itself an Expense — mismatches are refused `PARENT_TYPE_MISMATCH`), and
  suggests the next free child code (e.g. *515001 ค่าเครื่องบิน*, *515002 เบิกค่ารถ*). Mark the parent
