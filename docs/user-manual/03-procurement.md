...
> raised under **Claims** (`/claims` → GR Claims tab): enter the GR number, item,
> claim quantity and reason; resolve or reject it once the supplier responds.
> **From LINE chat**: `claim <PO/GR no> <qty> [เหตุผล]`
