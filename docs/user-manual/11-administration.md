...
- **Onboarding** — the queue of pending **คำขอเปิดบริษัท** to **อนุมัติ/ปฏิเสธ**, and **ออกลิงก์เชิญ** to issue a
  single-use, expiring invite link (the token is shown once — copy it then). Each request row shows the
