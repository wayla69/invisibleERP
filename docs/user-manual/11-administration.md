...
**เมนูพับตามประเภทธุรกิจ (industry nav folding — docs/50 B1).** On top of the platform defaults, a new SME
